...
if __name__ == "__main__":
    ...
    parser.add_argument("--starter", type=int, default=10, help="starter index.")
    ...
    pre_attacker = PreAttack(pre_attack_config, starter)
    ...
    simulation = Simulation(simulation_config, starter)
    simulation_path = simulation.action(args.questions)
    ...
    in_attacker = InAttack(in_attack_config, starter)
